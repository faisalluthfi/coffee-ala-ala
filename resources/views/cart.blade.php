...
<div class="container">
    <div class="row">
        <div class="col-12">
            <form action=/store method="POST" enctype="multipart/form-data" class="cart">
                @csrf
                    ...
                    @if(session('cart'))
                        @foreach(session('cart') as $id => $details)
                            ...
                            <tr data-id="{{ $id }}">
                                <td data-th="Product">
                                    <div class="row">
                                        <div class="col-sm-3 hidden-xs"><img src="https://source.unsplash.com/500x400?{{$category->name}}" width="100" height="100" class="img-responsive"/></div>
                                        <div class="col-sm-9">
