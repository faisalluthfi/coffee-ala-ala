...
<div class="col-lg-8">
<form method="post" action={{route('admin.category.update',$category->id)}} class="mb-5" enctype="multipart/form-data">
  @method('put')
    @csrf
    ...
    <div class="mb-3">
      ...
      {{-- <input type="hidden" name="oldImage" id="oldImage" value="{{old($product->image)}}"> --}}
      @if($product->image)
